<?php echo "<h1>Resultados. Desde aqui sera posible descargar los resultados de los formularios ya implementados y que han sido respondidos.</h1> "; ?>

<div class="bx--data-table-v2-container" data-table-v2>
  <h1 class="bx--data-table-v2-header">Tabla de prueba</h1>
